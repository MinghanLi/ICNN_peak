...
parser.add_argument('--fullretrain', default='Ture', dest='fullretrain', action='store_true', help='retrain all layers of the model')
...
def main():
    ...
    train_dir = join(data_dir, 'train/XR_SHOULDER')
    train_csv = join(data_dir, 'train_shoulder.csv')
    val_dir = join(data_dir, 'valid/XR_SHOULDER')
    val_csv = join(data_dir, 'valid_shoulder.csv')
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    torch.save(state, filename)           # save parameters of net
    if is_best:
